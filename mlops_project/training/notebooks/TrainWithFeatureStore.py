...
# ``mlops_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_project-experiment",
...
dbutils.widgets.text(
    "model_name", "dev.mlops_project.mlops_project-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops_project.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops_project.trip_dropoff_features",
